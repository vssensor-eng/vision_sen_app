...
checks = {
    ...
    'version': 'APP_VERSION = "0.6.7"' in s,
    ...
    'service_compare_transient_safe': 'getattr(self, "_manifest_ui_syncing", False) or not self._loaded_identity_serial' in s and 'loaded = tuple(self._loaded_manifest_sensors or ())' in s and 'if not selected or not loaded:' in s,
    'service_summary_sync_safe': 'Cihaz donanım bilgisi okunuyor...' in s,
    'connection_status_separate_row': 'grid(row=2, column=0, columnspan=6' in s and 'textvariable=self.com_status_var' in s,
}
