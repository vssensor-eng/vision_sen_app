...
class _LoginScreenState extends State<LoginScreen> {
  ...
  void initState() {
    super.initState();
    _login.text = widget.session.lastLogin;
  }
                ...
                children: [
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      boxShadow: [
                        BoxShadow(
                          color: AppTheme.cyan.withOpacity(.16),
                          blurRadius: 34,
                        ),
                      ],
                    ),
                  ...
                  Panel(
                    child: Column(
                      ...
                      children: [
                        ...
                        const Text(
                          'Binalarınızı, odalarınızı ve cihazlarınızı izlemek veya cihaz yapılandırmak için giriş yapın.',
                          style: TextStyle(
                  ...
                  const SizedBox(height: 22),
                  const Text(
                    'Oturumu açık tut seçiliyken uygulamayı kapatıp açmanız tekrar şifre istemez. ÇIKIŞ YAP işlemi oturumu bilinçli olarak kapatır.',
