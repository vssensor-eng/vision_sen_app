    ...
    return AppBackground(
      child: AnimatedBuilder(
        ...
        builder: (context, _) {
          ...
          final activeAlarmCount = session.alarms.length;
                        ...
                        IconButton(
                          onPressed: () {
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (_) => AlarmsScreen(session: session),
                              ),
                            );
                          },
                            ...
                            const Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 3),
                                  Text(
                                    'Bina, oda veya dolap seçip o konumdaki canlı sensörleri, cihazları ve alarmları Detay sekmesinden izleyin.',
                                    style: TextStyle(
                            ...
                            const Expanded(
                              child: Column(
                                ...
                                children: [
                                  ...
                                  SizedBox(height: 3),
                                  Text(
                                    'BLE kurulumu yalnız login sonrasında Yapılandır sekmesinden başlatılır.',
                                    style: TextStyle(
                                      color: AppTheme.muted,
                                      fontSize: 11,
                                      height: 1.35,
